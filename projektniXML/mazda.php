...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <div>
                    ...
                    <a class="navbar-brand" href="#">Mazda</a>
    ...
    <h1 class="d-flex justify-content-center">Mazda</h1>
