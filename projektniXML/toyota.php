...
$toyota = $cars['cars']['toyota'];
$toyota_corolla = [$toyota[0]];
$toyota_yaris = [$toyota[1]];
$toyota_rav4 = [$toyota[2]];
...
<body>
    ...
    <h1 class="d-flex justify-content-center">Toyota</h1>
    ...
    <div class="container" style="width: 60rem;">
        ...
        <table class="table table-dark text-white mt-2">
            ...
            <tbody>
                <?php foreach ($toyota_corolla as $car): ?>
        ...
        <table class="table table-dark text-white mt-2">
            ...
            <tbody>
                <?php foreach ($toyota_yaris as $car): ?>
        ...
        <table class="table table-dark text-white mt-2">
            ...
            <tbody>
                <?php foreach ($toyota_rav4 as $car): ?>
