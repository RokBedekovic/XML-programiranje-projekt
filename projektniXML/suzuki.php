...
$suzuki = $cars['cars']['suzuki'];
$suzuki_swift = [$suzuki[0]];
$suzuki_vitara = [$suzuki[1]];
$suzuki_ignis = [$suzuki[2]];
...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <div>
                    ...
                    <a class="navbar-brand" href="#">Suzuki</a>
    ...
    <h1 class="d-flex justify-content-center">Suzuki</h1>
    ...
    <div class="container" style="width: 60rem;">
        ...
        <table class="table table-dark text-white mt-2">
            ...
            <tbody>
                <?php foreach ($suzuki_swift as $car): ?>
        ...
        <table class="table table-dark text-white mt-2">
            ...
            <tbody>
                <?php foreach ($suzuki_vitara as $car): ?>
        ...
        <table class="table table-dark text-white mt-2">
            ...
            <tbody>
                <?php foreach ($suzuki_ignis as $car): ?>
